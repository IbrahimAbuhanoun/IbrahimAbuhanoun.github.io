...
excerpt: "The objective of my master's work was to improve the design of a soft robot design concept called a Vine Robot and test its navigation capability in a simulated jet engine environment. This helps us determine whether cost-effective soft robots can be a potential substitute to more expensive inspection equipment like borescopes that are more flexible and are able to operate without requiring engine overhauls.

<br><video width='700' controls style='display:block;margin:0 auto;max-width:100%;'><source src='/Vine_Tube_Motion_With_Bullet_Cap.mp4' type='video/mp4'></video><span style='display:block;text-align:center;'><em><strong>Demonstration of tube navigating the simulated engine environment</strong></em></span>"
...
A vine robot is a **tip-growing soft robot** — think of a folded sock that everts (turns inside-out) at the tip as air pressure is applied, extending outward like a growing vine.

- Energy efficient — translation energy is only needed at the tip
- Can deform to ¼ its original size and travel through harsh, cluttered environments
